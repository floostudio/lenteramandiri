  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Use this form to edit Company</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                <?php $a = $company->result(); ?>
                <?php echo form_open_multipart('master/company/update/'.$a[0]->COMPANY_ID); ?>
                    <!-- text input -->
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="<?php echo $a[0]->COMPANY_NAME; ?>" class="form-control" />
                    </div>
                    ...
                    <input type="hidden" name="userid" value="<?php echo $a[0]->COMPANY_ID; ?>" class="form-control" />
