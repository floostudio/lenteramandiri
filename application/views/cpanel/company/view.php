<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
          <li><a href="<?php echo site_url();?>/company"><i class="fa fa-dashboard"></i> Company</a></li>
      </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                        <a href="<?php echo site_url();?>/master/company/create"><button class="btn btn-primary" >Add company</button></a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <?php 
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($company->result() as $row) {
                                    ...
                                    echo "<td align='center'><a href='".base_url()."/master/company/toggleactive/{$row->COMPANY_ID}/{$row->IS_SHOW}'><div class='btn btn-view ".$bgColor." no-shadow' style='cursor:pointer;'>".$stats."</div></a></td>";
                                    echo "<td align='center'>"
                                . "<a href='". site_url()."/master/company/edit/".$row->COMPANY_ID." ' style='color:black;cursor:pointer;'>"
