  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Use this form to edit Department</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                <?php $a = $department->result(); ?>
                <?php echo form_open_multipart('master/department/update/'.$a[0]->M_DEPARTMENT_ID); ?>
                    <!-- text input -->
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="<?php echo $a[0]->M_DEPARTMENT_NAME; ?>" class="form-control" />
                    </div>
                    ...
                    <input type="hidden" name="userid" value="<?php echo $a[0]->M_DEPARTMENT_ID; ?>" class="form-control" />
