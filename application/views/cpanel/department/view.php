                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                        <a href="<?php echo site_url();?>/master/department/create"><button class="btn btn-primary" >Add department</button></a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <?php 
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($department->result() as $row) {
                                    ...
                                    echo "<td align='center'><a href='".base_url()."/master/department/toggleactive/{$row->M_DEPARTMENT_ID}/{$row->IS_SHOW}'><div class='btn btn-view ".$bgColor." no-shadow' style='cursor:pointer;'>".$stats."</div></a></td>";
                                    echo "<td align='center'>"
                                . "<a href='". site_url()."/master/department/edit/".$row->M_DEPARTMENT_ID." ' style='color:black;cursor:pointer;'>"
