<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
          Directorate Management</a>
        <small>Use this form to edit Directorate</small>
      </h1>
      <ol class="breadcrumb">
          <li><a href="<?php echo site_url();?>/directorate"><i class="fa fa-dashboard"></i> Directorate</a></li>
        <li class="active">Edit Directorate</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit directorate</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php 
                ...
                <?php $a = $directorate->result(); ?>
                <?php echo form_open_multipart('master/directorate/update/'.$a[0]->M_DIRECTORATE_ID); ?>
                    <!-- text input -->
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" value="<?php echo $a[0]->M_DIRECTORATE_NAME; ?>" class="form-control" />
                    </div>
                    ...
                    <input type="hidden" name="userid" value="<?php echo $a[0]->M_DIRECTORATE_ID; ?>" class="form-control" />
