  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Use this form to create new directorate</small>
      </h1>
      <ol class="breadcrumb">
          <li><a href="<?php echo site_url()?>/directorate"><i class="fa fa-dashboard"></i> Directorate</a></li>
        <li class="active">New directorate</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Add new directorate</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php 
                ...
                ?>
                <?php echo form_open_multipart('master/directorate/creating') ?>
