                ...
                <div class="col-xs-12">
                  <div class="box">
                    <div class="box-header">
                        <a href="<?php echo site_url();?>/master/title/create"><button class="btn btn-primary" >Add title</button></a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <?php 
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($title->result() as $row) {
                                    ...
                                    echo "<td align='center'><a href='".base_url()."/master/title/toggleactive/{$row->M_TITLE_ID}/{$row->IS_SHOW}'><div class='btn btn-view ".$bgColor." no-shadow' style='cursor:pointer;'>".$stats."</div></a></td>";
                                    echo "<td align='center'>"
                                . "<a href='". site_url()."/master/title/edit/".$row->M_TITLE_ID." ' style='color:black;cursor:pointer;'>"
